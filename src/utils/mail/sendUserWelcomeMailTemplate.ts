export const sendUserWelcomeMailTemplate = async (
  firstName: string,
  lastName: string,
  ...
  return (
    ...
    `, </h1>
            ...
            <td style="color: #153643; font-family: Arial, sans-serif; font-size: 12px; line-height: 24px; padding: 20px 0 30px 0;">
                ...
                <p style="margin: 0;">You have successfully created an account with us and we are glad to have you on board.</p>
                <p style="margin: 0; font-size: 12px;">In order to login to your account, please verify your account first.</p>
                <p style="margin: 0; font-size: 12px;">Your verification code is <b> ` +
    verificationCode +
    `</p>
            </td>
            </tr>
