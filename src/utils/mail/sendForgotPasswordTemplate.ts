export const sendForgotPasswordTemplate = async (
  firstName: string,
  lastName: string,
  token: string,
): Promise<any> => {
  return (
    ...
    `, </h1>
            ...
            <td style="color: #153643; font-family: Arial, sans-serif; font-size: 12px; line-height: 24px; padding: 20px 0 30px 0;">
                ...
                <p style="margin: 0;">Your password verification code is ` +
    token +
    `</p>
                <p style="margin: 0; font-size: 12px;">If you did not ask to reset your password, please ignore this email and nothing will change.</p>
            </td>
            </tr>
            <tr>
            <td>
    ...
    <tr>
        <td bgcolor="#83c324" style="padding: 30px 30px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
            <tr>
            <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;"><p style="margin: 0;">&reg; KoboFundMe<br />
            </p></td>
            <td align="right">
