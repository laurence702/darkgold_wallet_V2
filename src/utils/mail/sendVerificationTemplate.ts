export const sendVerificationTemplate = async (
  firstName: string,
  lastName: string,
  ...
  return (
    ...
    `, </h1>
            ...
            <td style="color: #153643; font-family: Arial, sans-serif; font-size: 12px; line-height: 24px; padding: 20px 0 30px 0;">
                ...
                <p style="margin: 0;">Your verification code is ` +
    verificationCode +
    `</p>
                <p style="margin: 0; font-size: 12px;">Use the code to verify your account and create a password.</p>
            </td>
            </tr>
            <tr>
            <td>
